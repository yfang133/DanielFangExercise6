...
```{r}
gardenharvest <- read_csv("2020_harvest.csv")
```
...
```{r}
  ...
  p2 <- ggplot(garden_harvest, aes(y = vegetable, x = weight)) + # Use the ggplot function. Set the x axis as weights of the vegetables, and the y axis as different kinds of vegetables
  geom_boxplot()
